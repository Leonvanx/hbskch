...
export const createBackup = (params: BackupV2Item, config?: AxiosRequestConfig) => {
  return request.get<ResultSuccess>('/tech/api/v2/backup/create', params, config);
};
...
export const restoreBackup = (params: { backupId: string }, config?: AxiosRequestConfig) => {
  return request.post<ResultSuccess>('/tech/api/v2/backup/restore', params, config);
};
