...
const searchTarget = ref<Supply>({});
const editTarget = ref<Supply & { onumber?: string }>({});
const editConfig = ref<SupplyConfig>();
...
const editExpert = (row: Supply & { onumber?: string }) => {
